...
import { Settings, BarChart, Phone, Zap, CheckCircle } from 'lucide-react';
        ...
        <div className="pt-24 pb-16">
            <section className="relative overflow-hidden pt-20 pb-32">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center max-w-4xl">
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight">
                        Stop Doing <span className="text-gradient">Robotic Work.</span>
                    </h1>
                    <p className="text-xl text-brand-text-muted mb-10 leading-relaxed max-w-2xl mx-auto">
                        We architect complex workflows via Make/Zapier that orchestrate your entire software stack automatically, saving hours.
                    </p>
                    <a href="#intake-form" className="btn-primary w-full sm:w-auto text-lg px-10 py-4">Free Up My Time</a>
                </div>
            </section>
            ...
            <section className="py-24 relative bg-brand-bg-alt/50 border-y border-brand-border">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-3 gap-8 text-center">
                    {[{ icon: <Zap className="w-8 h-8 text-accent-blue" />, title: "Instant Triggers", desc: "No more delays between data flowing from App A to App B." },
                    { icon: <Settings className="w-8 h-8 text-accent-purple" />, title: "Eliminate Human Error", desc: "Precision operations running consistently without manual typing and pasting." },
                    { icon: <BarChart className="w-8 h-8 text-accent-green" />, title: "Massive Time Savings", desc: "Most teams recover 20-30 hours per week of raw administrative bandwidth." }].map((b, i) => (
